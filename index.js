...
app.get('/backendweb', (req, res) => {
    res.render('web_docs/backend.ejs');
});

app.get('/frontendweb', (req, res) => {
    res.render('web_docs/frontend.ejs');
});

app.get('/versioncontrol', (req, res) => {
    res.render('web_docs/version_control.ejs');
});
